  ...
  return (
    ...
    >
      ...
      <div className="absolute z-0 w-full h-[999px] overflow-hidden [@media(0px<width<=768px)]:h-[600px] [@media(768px<width<=1024px)]:h-[700px]">
        <div className="absolute right-[0px] bottom-[0px] bg-brand-red w-[545.62px] h-[760.81px] rotate-[55.63deg] rounded-[50%] blur-[180px] [@media(0px<width<=768px)]:w-[300px] [@media(0px<width<=768px)]:h-[400px] [@media(768px<width<=1024px)]:w-[200px] [@media(768px<width<=1024px)]:h-[350px]"></div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center h-full relative z-1 py-[80px] [@media(0px<width<=768px)]:py-[120px] [@media(768px<width<=1024px)]:py-[140px]">
        <h1 className="text-[64px] font-plex font-semibold text-center mx-auto text-primary [@media(0px<width<=768px)]:text-[32px] [@media(0px<width<=768px)]:px-[24px] [@media(768px<width<=1024px)]:text-[48px] [@media(768px<width<=1024px)]:px-[40px] [@media(1024px<width<=1440px)]:text-[48px]">
          Akses <span className="text-brand-red font-bold font-plex">Beasiswa</span> Terpercaya<br /> dalam Genggaman
        </h1>
...
const IdentitasPortal = () => {
  const itemSedia = [
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-[50%] h-[50%] text-brand-red">
    ...
    >
      ...
      <div className="bg-[rgba(0,1,3,1)] w-[55%] h-auto rounded-[30px] pl-[100px] pr-[50px] pb-[80px] [@media(768px<width<=1024px)]:w-full [@media(768px<width<=1024px)]:px-[40px] [@media(0px<width<=768px)]:w-full [@media(0px<width<=768px)]:px-[24px]">
        ...
        <h1 className="text-[56px] text-surface font-plex font-semibold mt-[118px] [@media(1024px<width<=1440px)]:text-[32px]">
          <span className="bg-gradient-to-r from-brand-red via-brand-red-light to-[#515052] bg-clip-text text-transparent">Platform Independen</span> yang Berpihak pada Mahasiswa
        </h1>
        ...
        <div className="bg-gradient-to-r from-brand-red to-transparent w-[300px] h-[5px] mt-[30px]"></div>
        ...
        <div className="flex justify-center items-center bg-primary text-surface font-plex h-[150px] mt-[70px] mr-[40px] border border-brand-red text-center px-6 [@media(1024px<width<=1440px)]:h-[80px]">
      ...
      <div className="flex flex-col justify-center w-[45%] pr-[100px] py-[80px] [@media(768px<width<=1024px)]:w-full [@media(768px<width<=1024px)]:px-[40px] [@media(0px<width<=768px)]:w-full [@media(0px<width<=768px)]:px-[24px]">
        <div className="flex flex-col gap-[62px] w-full [@media(1024px<width<=1440px)]:gap-[30px]">
          {itemSedia.map((item) => (
            ...
            >
              <div className="bg-[#515052] border border-brand-red rounded-[10px] w-[93px] h-[93px] flex-shrink-0 flex items-center justify-center [@media(1024px<width<=1440px)]:w-[60px] [@media(1024px<width<=1440px)]:h-[60px]">
                {item.icon}
              </div>
...
const LayananBeasiswa = () => {
  const itemBeasiswa = [
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-[40%] h-[40%] text-brand-red">
    ...
    <div id="jenis" className="h-auto bg-surface pb-[200px]">
      <div className="flex flex-col mt-[136px] mx-[100px] gap-[30px] [@media(768px<width<=1024px)]:mx-[40px] [@media(0px<width<=768px)]:mx-[24px]">
        {itemBeasiswa.map((item) => (
          <div
            key={item.jenis}
            className="bg-gradient-to-r from-transparent via-transparent to-brand-red w-full h-[250px] [@media(0px<width<=768px)]:h-auto"
          >
            <div className="flex bg-surface w-[99%] h-[240px] [@media(0px<width<=768px)]:flex-col [@media(0px<width<=768px)]:h-auto">
              ...
              <div className="px-[20px] ml-[70px] w-[calc(100%-250px)] [@media(0px<width<=768px)]:ml-[0px] [@media(0px<width<=768px)]:w-full">
                <div className="flex justify-between mt-[20px]">
                  <h2 className="text-brand-red text-[24px] font-semibold">{item.jenis}</h2>
                  <div className="bg-brand-red text-surface text-[18px] flex items-center justify-center font-semibold font-plex w-[155px] h-[33px] rounded-[20px] [@media(0px<width<=768px)]:w-[110px] text-sm">
                    {item.pengelola}
                  </div>
                </div>
...
const PengajuanBeasiswa = () => {
  ...
  return (
    <div id="pengajuan" className="relative min-h-screen bg-brand-red-soft overflow-hidden flex items-center py-20">
      <div className="relative z-10 mx-[100px] w-full [@media(0px<width<=768px)]:mx-[24px]">
        <h1 className="font-plex text-[48px] font-bold text-primary">
          ...
          <span className="block text-brand-red-dark font-semibold">mendapatkan beasiswa</span>
        </h1>
        ...
        <div className="flex flex-row justify-between items-stretch mt-[80px] gap-8 [@media(0px<width<=1024px)]:flex-col">
          <div className="flex flex-col gap-4 flex-[1.2]">
            {listItems.map((item) => (
              <div
                key={item.text}
                className="group flex items-center bg-primary text-surface font-plex font-semibold h-[120px] transition-all duration-300 hover:bg-brand-red hover:translate-x-4"
              >
                <div className="ml-[40px] text-brand-red group-hover:text-surface transition-colors">
          ...
          <div className="group border-2 border-brand-red rounded-[4px] p-8 bg-white/40 backdrop-blur-sm flex flex-col items-center justify-center gap-8 flex-1 transition-all duration-500 hover:shadow-[15px_15px_0px_0px_theme(colors.brand-red)]">
            <div className="w-20 h-20 bg-brand-red rounded-full flex items-center justify-center text-surface mb-4 animate-bounce">
  ...
  return (
    <div className="font-plex bg-[rgba(0,1,3,1)]">
        ...
        <div className="relative z-10 max-w-[500px]">
          ...
          <div className="flex gap-5 flex-wrap">
            <button
              ...
              className="bg-brand-red text-surface text-[15px] font-semibold px-12 py-[18px] rounded-[4px] transition-all duration-200 hover:opacity-85 hover:-translate-y-0.5"
            >
              Mulai Cari
            </button>
      ...
      <div className="bg-[#140606] px-16">
        <hr className="border-none border-t border-brand-red opacity-70" style={{ borderTopWidth: "1px", borderTopStyle: "solid" }} />
      </div>
